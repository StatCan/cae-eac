...
![assistants Data Factory](images/DataFactoryWizards.png)

Voir [les tutoriels de la documentation Azure](https://docs.microsoft.com/fr-ca/azure/data-factory/introduction) pour obtenir plus de détails.
...
3.  Le service lié au type **Stockage Azure Data Lake Gen2** est votre compte de stockage *Data Lake*.
    ...
    ![Data Lake](images/DataFactoryConnectDataLake.png)
...
6.  Les services liés au type **Base de données SQL Azure** sont vos *bases de données*.
    ...
    ![Base de données SQL](images/DataFactorySQLDatabase2.png)
...
3.  Vérifiez la configuration de Git qui a été mise en place pour vous.
    ...
    ![configuration de Git](images/DataFactoryAzureGit.png)
...
![espaces de travail Data Factory](images/DataFactorySaveNoGit.png)
...
1.  Il y a un exemple de flux de travail qui montre la façon d'ingérer des données à partir de GitHub à l'aide d'un pipeline de Data Factory.
    ...
    ![Pipeline John Hopkins](images/DataFactoryJohnhopkinspipeline.png)

2.  Les données peuvent être filtrées depuis Data Factory.

    ![Transformation de données](images/transformData.png)
