...
# MAGIC %md
# MAGIC # Introduction to Data Analysis for Aspiring Data Scientists
...
# MAGIC 
# MAGIC * Humans are tool using animals animals
...
# MAGIC   - You want to build a code base to share with your colleaguges
...
# MAGIC %sh ls /dbfs/mnt/bdl-lde/examples/data_analysis_with_pandas/csse_covid_19_daily_reports
...
# MAGIC %sh head /dbfs/mnt/bdl-lde/examples/data_analysis_with_pandas/csse_covid_19_daily_reports/04-11-2020.csv
...
dbutils.fs.cp("/mnt/bdl-lde/examples/data_analysis_with_pandas/csse_covid_19_daily_reports/04-11-2020.csv", "file:////tmp/covid.csv")
...
src_path_base = "dbfs:/mnt/bdl-lde/examples/data_analysis_with_pandas/csse_covid_19_daily_reports/"
