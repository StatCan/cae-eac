...
2.  Vous devriez alors voir une liste des Data Factories auxquelles vous avez obtenu la permission d'accéder.
...
**NOTE :** La configuration de SSIS Integration n'est **PAS** recommandée. Si vous avez des questions, communiquez avec l'équipe de soutien par l'intermédiaire du canal https://cae-eac.slack.com.
...
4.  Lorsque vous créez un flux de travail, vous pouvez l'enregistrer dans votre branche. Cliquez sur **+ Nouvelle branche** dans le menu déroulant des branches pour créer une     branche de fonctionnalités. 
    ![Sauvegarder votre branche](images/DataFactorySaveBranch.png) **Enregistrement du flux dans votre branche.**
...
6.  Après avoir fusionné les modifications dans la branche de collaboration (master), cliquez sur **Publier** pour publier les changements de votre code de la branche dans       Azure Data Factory. Si vous obtenez un message d'erreur au moment de la publication, communiquez avec l'équipe de soutien par l'intermédiaire du canal https://cae- 
    eac.slack.com.
