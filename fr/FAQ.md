...
1.  Les fichiers peuvent être téléversés dans un compte de stockage externe, comme indiqué dans l'[ Explorateur de stockage Azure ] (StorageExplorer.md).
...
2.  SQL Server Management Studio ou un autre outil comme Power BI Desktop. (Ces outils sont offerts par défaut dans les images de machine virtuelle Data Science Virtual Machine.)

Étapes :

1.  Connectez-vous à votre machine virtuelle dans l'EAC.

2.  Lancez un outil comme SQL Server Management Studio.

3.  Entrez le nom de votre serveur dans le SQL Server.
